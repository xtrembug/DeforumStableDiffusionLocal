...
class DeforumGuiApp:
    ...
    def bt_save_click(self):
        ...
        dictionary = {
            ...
            "width":self.en_width.get(),
            "height":self.en_height.get(),
            "seed":self.en_seed.get(),
            "seed_behavior":self.var_behavior.get(),
            "sampler":self.var_sampler.get(),
            "steps":self.en_steps.get(),
            "scale":self.en_scale.get(),
            "ddim_eta":0.0,
            "filename_format":"{timestring}_{index}_{prompt}.png",
            "use_init":self.cb_useinit_var.get(),
            ...
            "max_frames":self.en_maxframes.get(),
            ...
            "extract_nth_frame":1,
            "interpolate_key_frames":self.cb_interpolate_var.get(),
            "interpolate_x_frames":self.en_interpolate.get(),
            "resume_from_timestring":self.cb_restimestring_var.get(),
